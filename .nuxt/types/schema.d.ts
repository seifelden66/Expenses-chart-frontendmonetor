...
declare module 'nuxt/schema' {
  interface NuxtConfig {
    ...
    modules?: (NuxtModule | string | [NuxtModule | string, Record<string, any>] | ["@nuxtjs/google-fonts", NuxtConfig["googleFonts"]] | ["nuxt-config-schema", NuxtConfig["nuxt-config-schema"]] | ["@nuxt/telemetry", NuxtConfig["telemetry"]])[],
  }
